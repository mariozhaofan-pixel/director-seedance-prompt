...
```text
@图片1 控制老人脸型、灰白短发、褪色蓝色外套、佝偻姿态。
```

场景图：

```text
@图片2 控制大棚宽度、金属管网格、塑料薄膜质感和泥泞窄道。
```

视频动作参考：

```text
@视频1 控制 lateral tracking speed、踉跄后恢复节奏和前景遮挡切点。
```

高风险视频参考：

```text
@视频1 只控制 lateral tracking speed 和动作节奏；不控制人物身份、服装、地点、色彩或声音。
```
