...
| 05_ACTION_PERFORMANCE_BODY_MECHANICS.md | 动作戏、真人肢体、演员表演、事故因果、武戏三路由 | 打斗、格斗、拳脚、摔拿、刀剑、兵器、技能、法术、能量招式 |
...
```text
静默选择空手格斗、武器格斗或能量招式；攻击、防御、接触、反作用、恢复姿态、蓄势和碰撞全部绑定具体秒段写入【运镜与时间轴】，不默认另设动作栏目。
```
