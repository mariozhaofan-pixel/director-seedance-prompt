...
| 文件 | 用途 | 检索触发 |
| --- | --- | --- |
| 01_CORE_EXECUTION_CONTRACT.md | 最高行为契约、默认 CUT、Seedance 硬约束、静默流程、续写证据门、节拍防火墙 | 所有复杂任务、续写、下一段、长项目 |
| 02_REFERENCE_ROUTER_AND_LOCKS.md | @图片 / @视频 / @音频 用途、证据分层、联网核实、图文冲突、声线锁定、正史参考与临时状态 | 用户上传素材、提到参考、配音、卡点、上一段视频/尾帧 |
...
| 05_ACTION_PERFORMANCE_BODY_MECHANICS.md | 动作戏、真人肢体、双向对白表演、主体任务、道具拓扑、事故因果、武戏三路由 | 打斗、格斗、拳脚、摔拿、刀剑、兵器、技能、法术、能量招式、多人调度 |
| 06_TIMELINE_EDITING_SOUND.md | 默认 CUT、精确时码路由、切镜、转场、声音叙事、音频卡点、部分验收、实际结尾优先 | 多段分镜、硬切、音频、节奏、音乐、续写 |
